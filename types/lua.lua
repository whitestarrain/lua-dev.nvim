...
--- @return any #string URI
function vim.uri_from_bufnr(bufnr) end

-- Get a URI from a file path.
--- @param path any #string Path to file
--- @return any #string URI
function vim.uri_from_fname(path) end

-- Get the buffer for a uri. Creates a new unloaded buffer if no
-- buffer for the uri already exists.
--- @param uri any #string
--- @return any #number bufnr
function vim.uri_to_bufnr(uri) end

-- Get a filename from a URI
--- @param uri any #string
--- @return any #string filename or unchanged URI for non-file URIs
function vim.uri_to_fname(uri) end
